#!/bin/bash
# ACTION: Install Nemo filemanager and some configs (show toolbar and double-click for active items)
...
apt-get install -y nemo catfish gvfs gvfs-fuse gvfs-backends
...
update-alternatives --install /usr/bin/x-file-manager x-file-manager /usr/bin/nemo 90
