#!/bin/bash
# ACTION: Install PCManFM filemanager and some configs (show toolbar and double-click for active items)
...
apt-get install -y pcmanfm catfish gvfs gvfs-fuse gvfs-backends
